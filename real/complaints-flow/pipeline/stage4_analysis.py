...
def _generate_faq_candidates_by_service(
    ...
    for service_name, cases in sorted(service_groups.items()):
        ...
        prompt = f"""You are analyzing customer complaints for the service: '{service_name}'

Below are all {len(cases)} complaints for this service. Extract the key FAQ questions that customers are asking.
