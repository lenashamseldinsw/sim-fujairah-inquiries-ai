"""
generate_customer_journey_section — stage6_artifacts.py companion

Generates Section 4: "رابعاً: التحليل الثاني — التحديات في رحلة المتعامل"
...
def generate_customer_journey_section(
    ...
    """
    Generate Section 4 — Customer Journey Challenges.
    ...
    try:
        ...
        # ── Prompt ────────────────────────────────────────────────────────────
        prompt = (
            'You are writing Section 4 of a formal Arabic government report on customer inquiry analysis\n'
            ...
            '\n'
            'CRITICAL DISAMBIGUATION — Traffic Fine Wrong Vehicle:\n'
            '  If any friction row describes citizens disputing fines because of "the vehicle\n'
            '  photo", the friction point is NOT "missing photo in notification".\n'
            '  The correct description is: the photo IS present but shows the WRONG vehicle.\n'
            '  The الإجراء التحسيني for this row must reference fixing the radar plate-matching\n'
            '  system — NOT adding a photo to the notification.\n'
            '  Do NOT write "إرفاق صورة المركبة في الإشعار" for this row.\n'
            '\n'
            '─────────────────────────────────────────────\n'
