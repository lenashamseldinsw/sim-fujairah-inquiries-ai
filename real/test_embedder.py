#!/usr/bin/env python3
"""
Quick test of guidebook search index.
"""
...
try:
    ...
    print("   ✓ GuidebookSearchIndex imported")
    ...
    search_index = GuidebookSearchIndex(str(guidebook_path), persist_dir=".guidebook_cache")
    print("   ✓ Search index initialized")

    print("\n4. Loading PDF and chunking...")
    chunks = search_index.load_and_chunk_pdf()
    ...
    results = search_index.query("كيفية التقديم على الخدمة", top_k=2)
